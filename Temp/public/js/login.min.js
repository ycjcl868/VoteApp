$(document).ready(function () {
  ...
  var username = $('#username'), flag1=false,flag2 = false,flag3 = false,password = $('#password'),noticeUsername = $("#auth-username"),noticePassword = $("#auth-password"),erroru = $('erroru'), errorp = $('errorp'), submit = $('#submit'), udiv = $('#u'), pdiv = $('#p'),cdiv = $('#c');
